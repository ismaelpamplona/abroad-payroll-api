...
CREATE TABLE public.fc_rf_by_city (
	...
	CONSTRAINT fc_rf_by_city_city_key UNIQUE (city),
...
ALTER TABLE public.fc_rf_by_city ADD CONSTRAINT fc_rf_by_city_city_fkey FOREIGN KEY (city) REFERENCES public.cities(id) ON DELETE CASCADE;