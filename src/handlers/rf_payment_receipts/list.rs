...
pub async fn list(
    ...
    Query(filters): Query<RFPaymentReceiptsFilter>,
) -> impl IntoResponse {
    ...
    let count_query = format!(
        "SELECT COUNT(*) FROM rf_payment_receipts rf {} {}",
    ...
    let query = format!(
        "{} {} {} ORDER BY rf.start_date DESC LIMIT {} OFFSET {}",
    ...
    match result {
        ...
        Err(error) => {
            eprintln!("Failed to fetch receipts: {}", error);
